...
import osp.icecap.sss.service.base.TermServiceBaseImpl;

/**
 * The implementation of the term remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>osp.icecap.sss.service.TermService</code> interface.
 *
 * <p>
...
public class TermServiceImpl extends TermServiceBaseImpl {
	...
	public Term addTerm(
		...
		return TermLocalServiceUtil.addTerm(name, version, type, displayNameMap, definitionMap, tooltipMap, synonyms, attributes, sc);
	}
