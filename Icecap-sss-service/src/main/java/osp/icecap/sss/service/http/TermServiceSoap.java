 ...
 * <code>osp.icecap.sss.model.TermSoap</code>. If the method in the
 * service utility returns a
 * <code>osp.icecap.sss.model.Term</code>, that is translated to a
 * <code>osp.icecap.sss.model.TermSoap</code>. Methods that SOAP
...
public class TermServiceSoap {
	...
	public static osp.icecap.sss.model.TermSoap addTerm(
		...
		try {
			osp.icecap.sss.model.Term returnValue = TermServiceUtil.addTerm(
	...
	public static osp.icecap.sss.model.TermSoap getTerm(long termId)
		throws RemoteException {

		try {
			osp.icecap.sss.model.Term returnValue = TermServiceUtil.getTerm(
				termId);
