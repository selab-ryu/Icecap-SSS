...
package osp.icecap.sss.service.persistence;
...
public class TermUtil {
	...
	public static List<Term> findByName(
		...
		return getPersistence().findByName(
			termName, start, end, orderByComparator, retrieveFromCache);
	}
