...
/**
 * The extended model interface for the Term service. Represents a row in the &quot;SSS_Term&quot; database table, with each column mapped to a property of this class.
 *
 * @author Jerry H. Seo, Won Cheol Ryu
 * @see TermModel
 * @generated
 */
@ImplementationClassName("osp.icecap.sss.model.impl.TermImpl")
@ProviderType
public interface Term extends PersistedModel, TermModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>osp.icecap.sss.model.impl.TermImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
