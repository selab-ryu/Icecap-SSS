    ...
    function DateTimePicker(element, options) {
        var picker = {},
            ...
            _createDatePicker = function () {
                ...
                $table.$prevm = _createCell($row, '<i class="icon-chevron-left"/>', 1, NAV['prevm'], "prevm");
//                $table.$prevm = _createCell($row, '<i class="icon-datepicker-prev"/>', 1, NAV['prevm'], "prevm");
                ...
                $table.$nextm = _createCell($row, '<i class="icon-chevron-right"/>', 1, NAV['nextm'], "nextm");
//                $table.$nextm = _createCell($row, '<i class="icon-datepicker-next"/>', 1, NAV['nextm'], "nextm");
            ...
            _createMonthPicker = function () {
                ...
                //tbody - 翻年按钮
                _createCell($row, '<i class="icon-chevron-left"/>', 1, NAV['prevy'], ' prevy');
                _createCell($row, '<i class="icon-chevron-right"/>', 1, NAV['nexty'], ' nexty');
//                _createCell($row, '<i class="icon-datepicker-prev"/>', 1, NAV['prevy'], ' prevy');
//                _createCell($row, '<i class="icon-datepicker-next"/>', 1, NAV['prevy'], ' nexty');
                //tbody - years
                for (var m = 0; m < 5; m++) {
            ...
            _createTimePicker = function (viewmode) {
                ...
                $table.focus = $table.$m;
                var $add = $('<td/>').append($('<i class="icon-chevron-up"/>')).data('nav', NAV['plus']);
                var $min = $('<td/>').append($('<i class="icon-chevron-down"/>')).data('nav', NAV['minus']);
